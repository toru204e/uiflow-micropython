...
CHARGE_ICON = "/system/sticks3/CHG.jpg"
...
SERVER_OK_IMG = "/system/sticks3/server_ok.jpg"
PLACEHOLDER_IMG = "/system/sticks3/placeholder.jpg"
STATE_WIFI_NO_SET_IMG = "/system/sticks3/wifiNeverSet.jpg"
STATE_WIFI_NG_IMG = "/system/sticks3/wifiNG.jpg"
STATE_WIFI_OK_IMG = "/system/sticks3/wifiOKServerNG.jpg"
STATE_SERVER_OK_IMG = "/system/sticks3/wifiOKServerOK.jpg"
SETUP_AP_IMG = "/system/sticks3/a1.jpg"
SETUP_WEB_IMG = "/system/sticks3/a2.jpg"
SETUP_WIFI_IMG = "/system/sticks3/a3.jpg"
SETUP_WIFI_NG_IMG = "/system/sticks3/a4.jpg"
SETUP_WIFI_OK_IMG = "/system/sticks3/a7.jpg"
SETUP_SERVER_NG_IMG = "/system/sticks3/a9.jpg"
SETUP_SERVER_OK_IMG = "/system/sticks3/a11.jpg"
...
class SetupApp(AppBase):
    ...
    def register_routes(self):
        ...
        async def handle_index(request):
            ...
            response = send_file("/system/sticks3/index.html")
            return response
    ...
    def on_launch(self):
        ...
        # Setup Access Point
        ap_name = "S3_" + binascii.hexlify(machine.unique_id()).upper().decode()[-4:]
